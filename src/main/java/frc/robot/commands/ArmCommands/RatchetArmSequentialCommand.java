...
public class RatchetArmSequentialCommand extends SequentialCommandGroup {
  public ArmSubsystem m_ArmSubsystem;
  public PneumaticsSubsystem m_PneumaticsSubsystem;
  public double m_targetPosition;

  public RatchetArmSequentialCommand(ArmSubsystem ArmSubsystem, PneumaticsSubsystem PneumaticsSubsystem, double targetPosition) {
